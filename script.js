...
const account2 = {
  ...
  movementsDates: [
    ...
    '2024-12-10T14:43:26.374Z',
    '2024-12-15T18:49:59.371Z',
    '2024-12-17T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const displayMovements = function (acc, sort = false) {
  ...
  combinedMovsDates.forEach((obj, index) => {
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // When the time is 0 seconds, stop timer logout user
    if (time === 0) {
      clearInterval(timer);
...
btnLogin.addEventListener('click', function (event) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    loginForm.style.margin = '0 0 20% 0';
    containerApp.style.opacity = 100;
